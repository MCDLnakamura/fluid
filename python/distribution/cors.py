...
def cors(path,time,dbz):
    ...
    #cors=np.where(dbz<=10,0,cors) #dbzが10以下は降水なしで0を代入
    # cors=np.where(10<dbz,3,cors) #とりあえず
    cors=np.where(40<dbz,1,cors)  #dbzが40より大きい場合は対流で1を代入
